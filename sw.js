const CACHE='cineprompt-v5';
const APP_SHELL=[
  './','./index.html','./coverage.html','./multishot.html','./manifest.webmanifest',
  './styles.css','./modes.css','./previews.css','./preview-fix.css','./movement.css','./coverage.css','./atlas.css?v=5','./coverage-page.css','./multishot.css',
  './app.js?v=4','./movement-bank.js','./coverage-page.js?v=4','./multishot.js?v=4','./pwa.js',
