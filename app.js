...
const focalStops = [18,25,35,50,85,135];
const focalLooks = ['Сильная широкоугольная перспектива, объёмное окружение.','Динамичная пространственная перспектива.','Кинематографичный environmental portrait.','Натуральная перспектива, близкая человеческому восприятию.','Льстивая портретная компрессия и мягкий фон.','Сильное сжатие пространства и узкий фон.'];
